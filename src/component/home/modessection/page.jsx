  ...
  return (
    <div className="py-12 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Title */}
        <h2
          className="text-6xl font-bold text-gray-900 inline-block pb-3 border-b-4 border-gray-900 mb-12"
          style={{ fontFamily: "Georgia, serif", fontStyle: "italic" }}
        >
          Modes
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 place-items-center">
          {modes.map((mode) => (
            <div
              key={mode.id}
              className="w-80 h-72 bg-[#52C048] clip-hex flex items-center justify-center border-4 border-teal-500 shadow-2xl"
            >
              <h3
